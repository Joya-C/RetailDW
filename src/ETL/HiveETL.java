...
public class HiveETL {
    ...
    private static void loadData(String InputPath, Statement statement) throws SQLException {
        ...
        String[][] csvToTempTableMappings = {
                ...
                {"Customer_dim.csv", "retailDW.customer_temp_dim"},

                {"Store.csv", "retailDW.store_temp_dim"},

                {"date_dim.csv", "retailDW.date_temp_dim"},

                {"Supplier.csv", "retailDW.supplier_temp_dim"},

                {"Product_dim.csv", "retailDW.product_temp_dim"},

                {"Sales_dim.csv", "retailDW.sales_temp_fact"}
        ...
        transferDataToFinalTable("retailDW.customer_temp_dim", "retailDW.customer_dim", statement);

        transferDataToFinalTable("retailDW.store_temp_dim", "retailDW.store_dim", statement);

        transferDataToFinalTable("retailDW.supplier_temp_dim", "retailDW.supplier_dim", statement);

        transferDataToFinalTable("retailDW.product_temp_dim", "retailDW.product_dim", statement);

        transferDataToFinalTable("retailDW.date_temp_dim", "retailDW.date_dim", statement);
    ...
    private static void transferSalesData(Statement statement) throws SQLException {
        ...
        String salesTransferSql = "from retailDW.sales_temp_fact " +

                "insert into table retailDW.sales_fact partition(year = '2023', month = '3') " +

                "select * where date_key <= '20230331' " +

                "insert into table retailDW.sales_fact partition(year = '2023', month = '4') " +

                "select * where date_key <= '20230430' and date_key >= '20230401' " +

                "insert into table retailDW.sales_fact partition(year = '2023', month = '5') " +
    ...
    private static void createTables(Statement statement) throws SQLException {
        ...
        statement.execute(
                ...
                "create table if not exists retailDW.store_temp_dim(" +
        ...
        statement.execute(
                ...
                "create table if not exists retailDW.customer_temp_dim(" +
        ...
        statement.execute(
                ...
                "create table if not exists retailDW.supplier_temp_dim(" +
        ...
        statement.execute(
                ...
                "create table if not exists retailDW.product_temp_dim(" +
        ...
        statement.execute(
                ...
                "create table if not exists retailDW.date_temp_dim(" +
        ...
        statement.execute(
                ...
                "create table if not exists retailDW.sales_temp_fact(" +
    ...
    private static void createDatabase(Statement statement) throws SQLException {
        ...
        statement.execute("CREATE DATABASE RetailDW");

        statement.execute("USE RetailDW");
    ...
    private static void createMaterializedViews(Statement statement) throws SQLException {
        ...
        statement.execute(
                "CREATE MATERIALIZED VIEW IF NOT EXISTS retailDW.profit_analysis_by_store " +
                        " AS " +
                        "  SELECT " +
                        "        store_id," +
                        "        sum(total_amount) as total_sales," +
